          ...
          <div class="userInfo">
            ...
            <div class="flex foll items-center">
              <div class="mr-5 flex items-center">
                ...
                <a href="/" class="cli">
                  <span class="mr-5">30</span>followers
                </a>
              </div>
              <span class="mr-5"> . </span>
              <div class="mr-5">
                <a href="/" class="flex items-center cli">
                  <span class="mr-5">20</span>following
                </a>
              </div>
              <span class="mr-5"> . </span>
            ...
            {/* <div class="details nobottomBorder organizations" v-if="orgs && (orgs.length > 0)">
          <h3>Organizations</h3>
          <div class="flex items-center mx-10 scrollX">
            <img :src=org.avatar_url alt="orgs" width="32px" height="32px" v-for="org in orgs" :key="org.id">
          </div>
        </div> */}
          </div>
        </div>
