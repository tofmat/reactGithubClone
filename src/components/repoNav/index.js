  ...
  return (
    <div>
      <div className="noMobile">
        <div className="butBord">
          <div className="flex repoNav top-0 position-sticky">
            <div className="picSpace px-15"></div>
            <div className="px-15 contentSpace nosmallPad scrollX">
              <div className="flex items-center justify-between">
                <nav className="repoTabs">
                  <ul className="flex">
                    ...
                    <li>
                      <a href="/" className="flex items-center selected">
                        <svg
                        ...
                        Repositories <span className="counter">10</span>
                      </a>
                    </li>
                    <li>
                      <a href="/" className="flex items-center">
                        <svg
                          className="octicon octicon-project UnderlineNav-octicon hide-sm"
                          height="16"
                          viewBox="0 0 16 16"
                          version="1.1"
                          width="16"
                    ...
                    <li>
                      <a href="/" className="flex items-center">
                        <svg
                          className="octicon octicon-package UnderlineNav-octicon hide-sm"
                          height="16"
                          viewBox="0 0 16 16"
                          version="1.1"
                          width="16"
